...
namespace WordCreator.Models
{
    ...
    {
        internal static string NarzednikImie(string imie)
        {
            string check = "";
        ...
        internal static string NarzednikNazwisko(string imie, string nazwisko)
        {
            string check = "";
        ...
        internal static string Chenger(string value)
        {
        ...
        internal static string EndOfWord(string Name)
        {
